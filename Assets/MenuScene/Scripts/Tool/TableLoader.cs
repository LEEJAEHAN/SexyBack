...
internal class TableLoader
{
    ...
    {
        gamemodetable = new Dictionary<string, MapData>();
        MapData data1 = new MapData("Map01", "10층돌파", 10, 3600);
        MapData data2 = new MapData("Map02", "20층돌파", 20, 7200);

        gamemodetable.Add(data1.ID, data1);
        gamemodetable.Add(data2.ID, data2);
