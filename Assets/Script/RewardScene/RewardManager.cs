    ...
    internal class RewardManager
    {
        ...
        internal void Init()
        {
            if (CurrentResult == null)
                RecordResult(Singleton<MapManager>.getInstance().Maps["Map01"], true, 50, 0, 0, 0);
            WaitingTime = 1.0f;
        ...
        internal void RecordResult(Map mapInfo, bool clear, int floor, int clearTime, int totalElementLevel, int FinishResearchCount)
        {
