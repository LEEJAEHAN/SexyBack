...
//        internal void FillTalents(Consumable talent1, Consumable talent2, Consumable talent3)
//        {
//            if(talent1 != null)
//            {
...
//        {
//            Singleton<ConsumableManager>.getInstance().Confirm(ConsumableType.Attack);
//        }
//        public void onClickE()
//        {
//            Singleton<ConsumableManager>.getInstance().Confirm(ConsumableType.Elemental);
//        }
//        public void onClickU()
//        {
//            Singleton<ConsumableManager>.getInstance().Confirm(ConsumableType.Util);
//        }
